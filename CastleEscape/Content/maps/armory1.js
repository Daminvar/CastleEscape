...
potionSeller.SetInteractFunc(function(player) {
	...
	items[0] = newItem("Major Health Potion", "Restores hp",100,0, 175)
	items[1] = newItem("Major Mana Potion" , "Restores mana", 0,60,150)
	items[2] = newItem("Major Mixture Potion", "Restores health and mana", 80,40,275)
