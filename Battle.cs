...
namespace CastleEscape
{
	...
	class Battle : State
	{
		...
		// constructor
		public Battle (Image bgTex, Player p, Enemy e, bool run) : base(game)
		{
		...
		{
			if (en.IsDead () || hasRun)
				StateManager.PopState (); else if (play.IsDead ()) {
		...
		private void handleInput ()
		{
			...
			if (selectedChoice == ("Light Punch"))
				...
				chosenAttack = "Light Punch"; else if (selectedChoice == ("Double Punch"))
			
				chosenAttack = "Double Punch"; else if (selectedChoice == ("Pummel"))
			
				chosenAttack = "Pummel"; else if (selectedChoice == ("Soul Cannon MP-1"))
			
				chosenAttack = "Soul Cannon"; else if (selectedChoice == ("Mind Break MP-2"))
			
				chosenAttack = "Mind Break"; else if (selectedChoice == ("Item"))
			
				chosenAttack = "Item"; else if (selectedChoice == ("Run"))
				chosenAttack = "Run";
		}
